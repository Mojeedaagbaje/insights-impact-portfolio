...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="section-animate bg-gradient-to-r from-blue-800 via-blue-700 to-indigo-800 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <Card className="bg-white/10 backdrop-blur-lg border-white/20 p-8">
              ...
              <div className="mt-8 pt-8 border-t border-white/20">
                ...
                <div className="flex space-x-4">
                  <a href="#" aria-label="Twitter" className="p-2 bg-blue-600/20 rounded-md text-white hover:bg-blue-600/40 transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                    </svg>
                  </a>
                  <a href="#" aria-label="LinkedIn" className="p-2 bg-blue-600/20 rounded-md text-white hover:bg-blue-600/40 transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fillRule="evenodd" d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" clipRule="evenodd" />
                    </svg>
                  </a>
                  <a href="#" aria-label="GitHub" className="p-2 bg-blue-600/20 rounded-md text-white hover:bg-blue-600/40 transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="lg:col-span-3">
            <Card className="bg-white p-8">
              <h3 className="text-2xl font-semibold mb-6 text-blue-800">Send a Message</h3>
              ...
              <form className="space-y-6">
                ...
                <Button type="submit" className="bg-blue-700 hover:bg-blue-800 text-white flex items-center gap-2">
